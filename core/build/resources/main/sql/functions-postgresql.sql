...
create
    or replace function linkapital.employed_growth_data(bigint)
    returns table
            (
                data_year   int,
...
create
    or replace function linkapital.employed_growth() returns setof record
as
$$
declare
    rec record;
...
begin
    for rec in
        select tcmi.cnpj,
               tcmi.fantasy_name,
               data_current_1,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_1),
               data_current_2,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_2),
               data_current_3,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_3),
               data_current_4,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_4),
               data_current_5,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_5),
               data_current_6,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_6),
               data_current_7,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_7),
               data_current_8,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_8),
               data_current_9,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_9),
               data_current_10,
               (select data_growth from linkapital.employed_growth_data(tc.id) where data_year = data_current_10)
...
create
    or replace function linkapital.phones(bigint) returns varchar as
$$
declare
    rec record;
    numbers
...
create
    or replace function linkapital.phones_rf(bigint) returns varchar as
$$
declare
    rec record;
    numbers
...
create
    or replace function linkapital.inventors(bigint) returns varchar as
$$
declare
    rec record;
    inventors
...
create
    or replace function linkapital.authors(bigint) returns varchar as
$$
declare
    rec record;
    authors
...
create
    or replace function linkapital.enum_activity_level(integer) returns varchar as
$$
begin
    case
...
create
    or replace function linkapital.enum_company_sector(integer) returns varchar as
$$
begin
    case
...
create
    or replace function linkapital.enum_company_size(integer) returns varchar as
$$
begin
    case
...
create
    or replace function linkapital.enum_enabled_situation(integer) returns varchar as
$$
begin
    case
...
create
    or replace function linkapital.enum_registration_situation(integer) returns varchar as
$$
begin
    case
