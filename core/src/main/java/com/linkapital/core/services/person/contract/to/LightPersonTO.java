...
@ApiModel(description = "The person data (light).")
@Getter
@Setter
public class LightPersonTO {
    ...
    @ApiModelProperty(value = "The registration number assigned by Caixa Econômica Federal to people who will " +
            "benefit from a social project and do not yet have a PIS registration.")
    private String nis;
    ...
    @ApiModelProperty(value = "The person spouse.")
    private LightSpouseTO spouse;

    @ApiModelProperty(value = "The Rural Property Registry.")
